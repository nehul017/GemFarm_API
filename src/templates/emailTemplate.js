                    ...
                    <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 600px;"
                        ...
                        <tr>
                            <td align="center" class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;">
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%; border: 1px solid #000" width="100%"
                                    cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            style="background-color:#ffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; color: #626262;"
                                            align="left">
                                            <div style="text-align: center;"><img src="https://res.cloudinary.com/dsqbfz1es/image/upload/v1738819008/x6d8ukucar8uk4bgtstt.png"
                                                    style="height: 100px; width: 180px;"></div>
                                            ...
                                            <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td
                                                        style="mso-padding-alt: 16px 24px; background-color: #6cb348; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                        <a target="_blank"
